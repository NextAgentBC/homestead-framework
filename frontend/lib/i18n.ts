...
const EN: Messages = {
  ...
  "chat.greeting": "Hi! I'm {assistant}, the site assistant. Ask me anything about what we do — or leave your email and we'll follow up.",
...
const ZH: Messages = {
  ...
  "chat.open": "打开对话",
  "chat.close": "关闭对话",
  "chat.greeting": "你好！我是{assistant}，网站的 AI 助手。关于我们的产品/服务有任何问题都可以问我——或者留下邮箱，我们会尽快联系你。",
