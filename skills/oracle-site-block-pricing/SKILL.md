---
name: oracle-site-block-pricing
description: "Pricing tiers block — add or edit a pricing tiers on any Oracle Site page by natural language. Thin recipe over the compose engine (pricing). Triggers (zh+en): 加价格表 / 套餐 / 定价 / add pricing / tiers / 改某档价格."
metadata:
  version: 0.1.0
  generated: true
  openclaw:
