---
name: homestead-site-block-logos
description: "Logo / trust strip block — add or edit a logo / trust strip on any Homestead page by natural language. Thin recipe over the compose engine (logos). Triggers (zh+en): 加 logo 墙 / 合作伙伴 / 技术栈条 / add a logo or trust strip."
metadata:
  version: 0.1.0
  generated: true
  openclaw:
