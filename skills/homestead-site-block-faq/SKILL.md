---
name: homestead-site-block-faq
description: "FAQ block — add or edit a faq on any Homestead page by natural language. Thin recipe over the compose engine (faq). Triggers (zh+en): 加 FAQ / 常见问题 / 问答 / add an FAQ / questions."
metadata:
  version: 0.1.0
  generated: true
  openclaw:
